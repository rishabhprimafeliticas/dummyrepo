...
router.post('/v2/create_send_token_request',
    [
...
router.get('/v2/get_send_aware_token_requests_async', verify,
    asyncHandler(sendtokenhandler.handlers.getSendAwareTokenRequestsAsync));


router.get('/v2/get_all_send_aware_token_requests_async', verify,
    asyncHandler(sendtokenhandler.handlers.getAllSendAwareTokenRequestsAsync));

//done
router.post('/v2/create_select_receiver_async',
    [
    ],
    verify,
...
//done
router.get('/v2/get_select_receiver', verify,
    asyncHandler(sendtokenhandler.handlers.getSelectedReceiverAsync));

router.get('/v2/get_send_aw_token_details', verify,
    asyncHandler(sendtokenhandler.handlers.getSendAwareTokenDetailsAsync));


router.post('/v2/create_select_aware_token_async',
    [
    ],
    verify,
...
//done
router.get('/v2/get_proof_of_delivery_async', verify,
    asyncHandler(sendtokenhandler.handlers.getSelectedProofOfDeliveryAsync));


//done
router.post('/v2/post_recap',
    [
    ],
    verify,
...
router.get('/v2/get_purchase_order',
    [], verify, asyncHandler(sendtokenhandler.handlers.getPurchaseOrdersAsync));
