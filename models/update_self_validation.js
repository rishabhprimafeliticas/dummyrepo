...
const SelfValidationSchema = new mongoose.Schema({
    ...
    declaraction_number: { type: String, required: true },
    sustainble_material: [{
        ...
        total_kgs: { type: String, required: false, default: null },
        ...
        selfvalidationData: [{
            id: { type: String, required: false, default: null },
            composition_material_id: { type: String, required: false, default: null },
            composition_material: { type: String, required: false, default: null },
            sustainability_claim: { type: String, required: false, default: null },
            color: { type: String, required: false, default: null },
            feedstock_recycled_materials: { type: String, required: false, default: null },
            ...
            feedstock_source_type: { type: String, required: false, default: null },
            ...
            source_certifications: { type: String, required: false, default: null },
            source_certifications_list: { type: Array, required: false, default: null },
...
module.exports = mongoose.model('update_self_validation', SelfValidationSchema);
